...
**Тестов:** 2685, 0 сбоев, 1 предопределённый skip
**Сборка:** 0 errors, 0 warnings
**Покрытие:** 90.04% line-rate (CI gate 80%)
**Последнее обновление:** 18.08.2026 — Кандидат 1 обзора №4 (#88, тикет #89, PR #91): один конвейер рендеринга — правила «модель → примитивы» собраны в модуль RenderRules, поверхности (канвас/preview/печать/сетка) — тонкие делегаты; два живых дефекта anchor'ов текста устранены (preview и печать), канвас байт-в-байт, coverage 90.04%
...
|------|----------|--------|------|
| **1** | Редактор шаблонов листов | ✅ ЗАВЕРШЁН (2685 тестов, 100%) | Q2 2026 |
...
- ✅ **2685 тестов**, 0 сбоев, 1 предопределённый skip
- ✅ **Покрытие:** 90.04% line-rate (CI gate 80%)
- ✅ **Сборка:** 0 errors, 0 warnings
...
**Последнее обновление:** 18.08.2026 — Кандидат 1 обзора №4 (#88, тикет #89, PR #91): один конвейер рендеринга — создан модуль правил `RenderRules` (карты шрифт/dash/hex/выравнивание, Y-flip, anchor-политика на тип); канвас-конвертеры — тонкие делегаты (байт-в-байт), preview и печать исправлены по anchor'ам текста (два живых дефекта устранены: preview ставил текст по FontSizeMicrons, печать — без высоты и компенсации поворота), дубли правил удалены бесследно; coverage 90.04% (2685 тестов)
