...
| **Coverage** | **76.4% line-rate** | **89.86% line-rate (gate 80% достигнут)** |
| **CI coverage gate** | **75%** | **80% (факт 89.86%)** |
