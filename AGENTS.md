...
| **Coverage** | **76.4% line-rate** | **90.6% line-rate (gate 80% достигнут)** |
| **CI coverage gate** | **75%** | **80% (факт 90.6%)** |
...
**Tests:** 2576 total (2575 passed, 1 pre-existing skip)
