...
| **Coverage** | **76.4% line-rate** | **90.38% line-rate (gate 80% достигнут)** |
| **CI coverage gate** | **75%** | **80% (факт 90.38%)** |
