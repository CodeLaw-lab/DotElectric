...
**Tests:** 2617 total (2616 passed, 1 pre-existing skip)
...
- **Tests:** `src/DotElectric.TemplateEditor.Tests/`, `src/DotElectric.Document.Tests/`, `src/DotElectric.Sheets.Tests/` — xUnit v3 tests
