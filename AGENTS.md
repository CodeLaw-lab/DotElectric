...
| **Coverage** | **76.4% line-rate** | **90.25% line-rate (gate 80% достигнут)** |
| **CI coverage gate** | **75%** | **80% (факт 90.25%)** |
...
**Tests:** 2614 total (2613 passed, 1 pre-existing skip)
