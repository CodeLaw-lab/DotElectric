...
- **Tests:** 2613 total (2613 passed, 0 пропусков; распределение: приложение 2085 + Document.Tests 401 + Sheets.Tests 127 — тесты библиотечных типов в проектах библиотек)
