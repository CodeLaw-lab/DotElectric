...
- TabItemMiddleClickBehavior / PreviewLineChangedBehavior — STA-тесты (требуют полного визуального дерева)
...
- TabItemMiddleClickBehavior / PreviewLineChangedBehavior — integration/UI тесты с STA
...
**Пропущено:** `TabItemMiddleClickBehavior`, `PreviewLineChangedBehavior` — требуют полного визуального дерева.
