...
|---|------|----------|--------------|---------------|
| 1 | `AGENTS.md` | status | Sprint history, Common Mistakes, build status, test count, coverage | 2026-08-10 |
| 2 | `CHANGELOG.md` | release | [Unreleased] секция, Added/Changed/Fixed/Removed, метрики | 2026-08-10 |
| 3 | `README.md` | readme | Описание проекта, build, dependencies, structure | 2026-07-20 |
| 4 | `docs/00_Индекс_документов.md` | index | Реестр всех docs/ файлов, метрики, даты, статус | 2026-08-10 |
...
| 10 | `docs/19_Статус_проекта.md` | status | Test count, coverage, sprint list, FR coverage, динамика | 2026-08-10 |
