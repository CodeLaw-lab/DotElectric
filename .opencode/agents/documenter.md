...
test_count:
  AGENTS.md: 2636
  CHANGELOG.md: 2637  ← расхождение
  docs/19: 2636
  docs/00: 2636

coverage:
  AGENTS.md: 90.18%
  CHANGELOG.md: 90.2%  ← расхождение
  docs/19: 90.18%
  docs/00: 90.18%
```
...
### Metrics verified
- test_count: 2636 (4/4 sources)
- coverage: 90.18% (4/4 sources)
- sprint_count: 42 (3/3 sources)
...
- <file>:<line> — test_count=2636, expected=2637
```
